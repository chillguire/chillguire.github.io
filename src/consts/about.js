...
`,
	...
	skills: [
		...
		},
		{
			...
			elements: [
				'Node.js', 'Git', 'Docker', 'Linux', 'Redis', 'MongoDB', 'PostgreSQL', 'Confluence', 'Jira', 'Jenkins', 'Xcode', 'Postman', 'Swagger', 'AWS', 'Amazon EC2', 'AWS CloudFormation', 'GitHub Actions', 'AWS Lambda', 'Amazon Cognito', 'Amazon EventBridge', 'Amazon CloudWatch', 'AWS IAM', 'nginx',
			]
		},
		{
		...
		},
		{
			...
			elements: [
				'REST APIs', 'HTTP', 'WebSockets', 'OAuth 2.0', 'OpenID Connect', 'JWT', 'SAML', 'SSO'
			]
		},
		{
			name: 'Methodologies',
